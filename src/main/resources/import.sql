...
INSERT INTO customers (name, last_name, email, created_at, photo) VALUES ('John', 'Doe', 'johndoe@gmail.com', NOW(), '');
INSERT INTO customers (name, last_name, email, created_at, photo) VALUES ('Sarah', 'Miller', 'sarahmiller@gmail.com', NOW(), '');
INSERT INTO customers (name, last_name, email, created_at, photo) VALUES ('David', 'Wilson', 'davidwilson@gmail.com', NOW(), '');
INSERT INTO customers (name, last_name, email, created_at, photo) VALUES ('Jessica', 'Brown', 'jessicabrown@gmail.com', NOW(), '');
INSERT INTO customers (name, last_name, email, created_at, photo) VALUES ('Christopher', 'Davis', 'christopherdavis@gmail.com', NOW(), '');
...
INSERT INTO users (username, password, enabled) VALUES ('user' , '$2a$10$4JEcJd8lvR90w.3SA/krO.RFKWCkmcUDeIt2QUALG3CcVrVEoD1FW', 1);
INSERT INTO users (username, password, enabled) VALUES ('admin' , '$2a$10$vSenzTcdTCQEYZ149.h7RO6orNx9gpzrd02NXsSGv6pYj4RJ9pgUa', 1);
